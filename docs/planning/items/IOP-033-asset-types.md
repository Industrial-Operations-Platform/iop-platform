...
Asset type model. Resultado esperado: Sensor, motor, conveyor, PLC, etc. configurables
...
Sensor, motor, conveyor, PLC, etc. configurables

## Requirements

- Entregar únicamente el resultado descrito para IOP-033.

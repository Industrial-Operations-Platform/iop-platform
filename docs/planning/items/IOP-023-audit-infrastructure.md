...
Audit infrastructure. Resultado esperado: Cambios materiales generan audit records
...
Cambios materiales generan audit records

## Requirements

- Entregar únicamente el resultado descrito para IOP-023.

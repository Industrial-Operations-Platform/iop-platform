...
Maintenance history. Resultado esperado: Historial visible desde asset
...
Historial visible desde asset

## Requirements

- Entregar únicamente el resultado descrito para IOP-075.

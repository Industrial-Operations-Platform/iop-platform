...
CI baseline. Resultado esperado: Push/PR ejecuta lint, tests y validation
...
Push/PR ejecuta lint, tests y validation

## Requirements

- Entregar únicamente el resultado descrito para IOP-021.

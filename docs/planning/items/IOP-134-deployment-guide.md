...
Deployment documentation. Resultado esperado: Otro entorno puede desplegar IOP
...
Otro entorno puede desplegar IOP

## Requirements

- Entregar únicamente el resultado descrito para IOP-134.

# IOP-015 — Crear Docker development environment
...
Crear Docker development environment. Resultado esperado: Un comando inicia frontend, API y PostgreSQL
...
Un comando inicia frontend, API y PostgreSQL

## Requirements

- Entregar únicamente el resultado descrito para IOP-015.
- Aplicar únicamente el stack y los contratos aceptados; los hosts no son microservicios de negocio.
- El comando final debe arrancar frontend, API y PostgreSQL reales una vez disponibles sus bootstraps; no usar aplicaciones falsas para declarar el criterio cumplido.
...
[IOP-016](IOP-016-backend-bootstrap.md), [IOP-017](IOP-017-frontend-bootstrap.md), [IOP-018](IOP-018-configuration-management.md), [IOP-019](IOP-019-database-bootstrap.md)

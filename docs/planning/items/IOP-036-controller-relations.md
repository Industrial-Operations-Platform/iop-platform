# IOP-036 — Controller relationships
...
Controller relationships. Resultado esperado: Sensor/motor → controller model
...
Sensor/motor → controller model

## Requirements

- Entregar únicamente el resultado descrito para IOP-036.

# IOP-069 — Maintenance status workflow
...
Maintenance status workflow. Resultado esperado: Open/In progress/Blocked/Done
...
- Entregar únicamente el resultado descrito para IOP-069.

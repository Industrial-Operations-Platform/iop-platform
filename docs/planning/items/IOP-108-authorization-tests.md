# IOP-108 — Authorization test suite
...
Authorization test suite. Resultado esperado: Cross-scope access falla
...
Cross-scope access falla

## Requirements

- Entregar únicamente el resultado descrito para IOP-108.
...
[IOP-029](IOP-029-rbac-enforcement.md), [IOP-030](IOP-030-membership-model.md)

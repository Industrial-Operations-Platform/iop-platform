...
Ambiguous aliases. Resultado esperado: UI maneja múltiples matches
...
UI maneja múltiples matches

## Requirements

- Entregar únicamente el resultado descrito para IOP-082.
...
[IOP-081](IOP-081-locator-search.md), [IOP-037](IOP-037-asset-aliases.md)

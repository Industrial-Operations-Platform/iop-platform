...
Shift instances. Resultado esperado: Shift concreto con fecha/inicio/fin
...
Shift concreto con fecha/inicio/fin

## Requirements

- Entregar únicamente el resultado descrito para IOP-053.
...
[IOP-052](IOP-052-shift-types.md)

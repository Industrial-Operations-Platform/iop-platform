...
Open issues. Resultado esperado: Temas abiertos sobreviven al cambio de turno
...
Temas abiertos sobreviven al cambio de turno

## Requirements

- Entregar únicamente el resultado descrito para IOP-064.

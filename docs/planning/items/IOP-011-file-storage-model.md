# IOP-011 — Definir file/map storage
...
Definir file/map storage. Resultado esperado: Se define dónde viven mapas, RAW imports y attachments
...
Se define dónde viven mapas, RAW imports y attachments

## Requirements

- Entregar únicamente el resultado descrito para IOP-011.

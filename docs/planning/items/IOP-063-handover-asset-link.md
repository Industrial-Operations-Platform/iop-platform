...
Asset-linked handover. Resultado esperado: Nota puede relacionarse con asset
...
Nota puede relacionarse con asset

## Requirements

- Entregar únicamente el resultado descrito para IOP-063.

...
Workplace/assignment targets. Resultado esperado: Persona asignable a zona/función
...
Persona asignable a zona/función

## Requirements

- Entregar únicamente el resultado descrito para IOP-054.

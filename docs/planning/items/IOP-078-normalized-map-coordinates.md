# IOP-078 — Normalized coordinates
...
Normalized coordinates. Resultado esperado: Coordenadas 0..1
...
- Entregar únicamente el resultado descrito para IOP-078.

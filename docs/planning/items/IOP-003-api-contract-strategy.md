# IOP-003 — Definir estilo API y contratos
...
Definir estilo API y contratos. Resultado esperado: Se decide REST/otro enfoque, versionado, errores y contratos
...
Se decide REST/otro enfoque, versionado, errores y contratos

## Requirements

- Entregar únicamente el resultado descrito para IOP-003.
...
[IOP-002](IOP-002-technology-stack.md)

...
Technician assignments. Resultado esperado: Quién trabaja dónde y cuándo
...
Quién trabaja dónde y cuándo

## Requirements

- Entregar únicamente el resultado descrito para IOP-055.

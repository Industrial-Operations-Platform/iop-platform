...
Shift type configuration. Resultado esperado: Shift names configurables por site
...
Shift names configurables por site

## Requirements

- Entregar únicamente el resultado descrito para IOP-052.

# IOP-035 — Asset parent relationships
...
Asset parent relationships. Resultado esperado: Ciclos imposibles y jerarquía válida
...
Ciclos imposibles y jerarquía válida

## Requirements

- Entregar únicamente el resultado descrito para IOP-035.

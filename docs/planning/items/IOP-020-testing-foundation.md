...
Testing foundation. Resultado esperado: Unit/integration/e2e strategy ejecutable
...
Unit/integration/e2e strategy ejecutable

## Requirements

- Entregar únicamente el resultado descrito para IOP-020.

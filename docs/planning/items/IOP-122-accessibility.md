...
Accessibility baseline. Resultado esperado: Navegación/contrast/labels básicos
...
Navegación/contrast/labels básicos

## Requirements

- Entregar únicamente el resultado descrito para IOP-122.

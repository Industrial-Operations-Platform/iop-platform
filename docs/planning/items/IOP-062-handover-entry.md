...
Handover entries. Resultado esperado: Técnico puede preparar notas
...
Técnico puede preparar notas

## Requirements

- Entregar únicamente el resultado descrito para IOP-062.
...
[IOP-060](IOP-060-handover-record.md), [IOP-061](IOP-061-handover-categories.md), [IOP-029](IOP-029-rbac-enforcement.md)

...
Assignment history. Resultado esperado: Cambios quedan auditados
...
- Entregar únicamente el resultado descrito para IOP-059.
...
[IOP-055](IOP-055-shift-assignments.md), [IOP-023](IOP-023-audit-infrastructure.md)

...
Asset search. Resultado esperado: Búsqueda por code, alias y metadata
...
Búsqueda por code, alias y metadata

## Requirements

- Entregar únicamente el resultado descrito para IOP-040.

...
Map upload. Resultado esperado: Plano puede registrarse
...
Plano puede registrarse

## Requirements

- Entregar únicamente el resultado descrito para IOP-077.
...
[IOP-076](IOP-076-map-model.md), [IOP-029](IOP-029-rbac-enforcement.md)

...
Maintenance record model. Resultado esperado: Trabajo técnico puede registrarse
...
Trabajo técnico puede registrarse

## Requirements

- Entregar únicamente el resultado descrito para IOP-068.

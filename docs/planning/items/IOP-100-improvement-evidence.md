...
Evidence. Resultado esperado: Notas/resultados
...
- Entregar únicamente el resultado descrito para IOP-100.
...
[IOP-098](IOP-098-improvement-action.md), [IOP-011](IOP-011-file-storage-model.md)

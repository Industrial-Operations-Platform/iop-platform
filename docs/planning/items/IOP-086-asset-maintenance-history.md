...
Maintenance history. Resultado esperado: Reparaciones/mantenimientos visibles
...
Reparaciones/mantenimientos visibles

## Requirements

- Entregar únicamente el resultado descrito para IOP-086.

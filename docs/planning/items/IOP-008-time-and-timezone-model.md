# IOP-008 — Definir manejo temporal
...
Definir manejo temporal. Resultado esperado: Timezones, UTC, shifts nocturnos y timestamps definidos
...
Timezones, UTC, shifts nocturnos y timestamps definidos

## Requirements

- Entregar únicamente el resultado descrito para IOP-008.

# IOP-104 — WinCC adapter contract
...
WinCC adapter contract. Resultado esperado: Interfaz read-only desacoplada
...
Interfaz read-only desacoplada

## Requirements

- Entregar únicamente el resultado descrito para IOP-104.
- WinCC y Ultimo son candidatos de adaptador, no entidades core; Entra se integra en Authentication.
- Contrato read-only primero; conectar una instalación real solo con acceso autorizado y alcance explícito. Los dobles de prueba deben estar etiquetados y no cuentan como compatibilidad real.
...
[IOP-012](IOP-012-source-integration-contract.md), [IOP-102](IOP-102-integration-registry.md)

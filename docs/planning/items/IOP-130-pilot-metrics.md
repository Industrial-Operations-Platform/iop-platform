...
Pilot metrics. Resultado esperado: Se miden KPIs definidos en IOP-001
...
Se miden KPIs definidos en IOP-001

## Requirements

- Entregar únicamente el resultado descrito para IOP-130.
...
[IOP-001](IOP-001-v1-personas-and-pilot-workflow.md), [IOP-129](IOP-129-end-to-end-scenario.md)

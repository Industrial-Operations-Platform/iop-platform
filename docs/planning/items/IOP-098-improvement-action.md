...
Improvement action. Resultado esperado: Acción asociable a problema/asset
...
Acción asociable a problema/asset

## Requirements

- Entregar únicamente el resultado descrito para IOP-098.

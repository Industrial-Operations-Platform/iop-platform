...
Handover categories. Resultado esperado: Safety, Success, Repair, Spare, etc. configurables
...
Safety, Success, Repair, Spare, etc. configurables

## Requirements

- Entregar únicamente el resultado descrito para IOP-061.
...
[IOP-060](IOP-060-handover-record.md)

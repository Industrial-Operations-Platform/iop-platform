...
Unmapped assets. Resultado esperado: Assets sin posición son visibles
...
Assets sin posición son visibles

## Requirements

- Entregar únicamente el resultado descrito para IOP-083.
...
[IOP-080](IOP-080-asset-locator-ui.md), [IOP-034](IOP-034-asset-lifecycle.md)

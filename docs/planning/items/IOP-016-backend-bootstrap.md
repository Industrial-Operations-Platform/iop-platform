...
Bootstrap backend. Resultado esperado: API arranca, health endpoint responde y tests funcionan
...
API arranca, health endpoint responde y tests funcionan

## Requirements

- Entregar únicamente el resultado descrito para IOP-016.
...
[IOP-002](IOP-002-technology-stack.md), [IOP-003](IOP-003-api-contract-strategy.md), [IOP-013](IOP-013-observability-baseline.md)

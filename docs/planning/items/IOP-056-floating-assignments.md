...
Springer/floating assignment. Resultado esperado: Rotación entre áreas soportada
...
Rotación entre áreas soportada

## Requirements

- Entregar únicamente el resultado descrito para IOP-056.
